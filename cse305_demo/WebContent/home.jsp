			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form name="signupForm" action="${pageContext.request.contextPath}/signup" method="POST">
						...
						<div class="form-group">
							<div class="input-group">
								<input type="email" class="form-control" id="email" name = "accountNo" placeholder="Email"/>
								<span class="input-group-addon">
									<span class="glyphicon glyphicon-envelope"></span>
								</span>
							</div>
						</div>
						<input type="submit" id ="submitBt" value="Sign Up" class="btn btn-block sign-up-button" data-dismiss="modal"/>

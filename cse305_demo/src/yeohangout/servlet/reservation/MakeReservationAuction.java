...
@WebServlet(name = "make-auction", urlPatterns = {"/make-auction"})
public class MakeReservationAuction extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(MyUtils.getUserType()==0) {
			...
			{
				rd = request.getRequestDispatcher("/home-search/search-summary-auction.jsp");
			}

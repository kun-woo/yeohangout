            	...
            	<section class="col-xs-12 col-sm-6 col-md-6 col-lg-6 ">
                	...
                	<article role="pge-title-content">
                    	...
                    	<header>
                        	...
                        	<h2><span>Yeo Hangout</span> A Brand new Travel Agency.</h2>

                        </header>

                        <p>This is the story of Yeo Hangout, a window for a creative travel agency.</p>
                	...
                	<ul class="grid-lod effect-2" id="grid">
                    	...
                    	<li>
                            ...
                            <figcaption>
                                    ...
                                    <h2>Studio Stony Brook <span>Exhibition</span></h2>

				...
				<div class="row search-row">
					...
					<div class="row cart-row">
						<div class="col-xs-12 col-sm-2 col-md-2">
							<a href="#"> <img src="../images/airline/${result.airlineID}.png" class="img-responsive">
							</a>
						</div>
						...
						<div class="col-xs-6 col-sm-2 col-md-2">
							...
							<div class="no-wrap"><%//Dpet-airport%>${result.depAirportID} - ${result.arrAirportID}<%//Land-airport%></div>
						</div>
						<div class="col-xs-6 col-sm-2 col-md-2">
							<h3>1 Stop</h3>

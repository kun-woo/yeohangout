...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<!-- Edit Modal -->
	<%
		int dash_edit_cust_index = (int)session.getAttribute("dash_edit_cust");
		ArrayList<Integer> cust_edit_arr = (ArrayList<Integer>)session.getAttribute("cust_edit_arr");
	%>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					%>
					<form role="form" action="../edit-customer" class="form-horizontal" method="post">
